    ...
    <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-900'}`}>
      ...
      <nav className={`sticky top-0 z-40 backdrop-blur-md border-b transition-all duration-300 ${
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center items-center space-x-1 sm:space-x-3 lg:space-x-6 py-3 sm:py-4">
            {useMemo(() => [
              { id: 'home', label: 'Home' },
              ...
              <button
                ...
                className={`px-3 sm:px-4 py-2 text-sm font-medium focus:outline-none rounded-lg min-h-[44px] flex items-center justify-center transition-all duration-200 ${
                  isDarkMode 
            ...
            <div className="relative contact-dropdown z-50">
              <button
                ...
                className={`px-3 sm:px-4 py-2 text-sm font-medium focus:outline-none rounded-lg min-h-[44px] flex items-center justify-center transition-all duration-200 gap-1 ${
                  isDarkMode 
                    ? 'text-gray-300 hover:text-white hover:bg-gray-800/50' 
                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100/50'
                }`}
                ...
                <div className={`absolute top-full right-0 mt-2 w-40 rounded-md shadow-lg z-[100] ${
                  ...
                  <div className="py-1">
                    <a
                      ...
                      className={`flex items-center gap-2 px-2 py-1.5 text-sm transition-colors min-h-[32px] ${
                        isDarkMode 
